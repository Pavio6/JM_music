<template>
  <div class="edit-singer-container">
    <h1 class="page-title">编辑歌手</h1>
    <div class="content-box">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" class="singer-form">
        ...
        <el-form-item label="歌手名称" prop="singerName">
          <el-input v-model="form.singerName" placeholder="请输入歌手名称" disabled />
        </el-form-item>
...
<script setup>
  ...
  import { uploadFile, deleteFile } from '@/api/auth';
  ...
  const initData = () => {
    ...
    const singerData = router.currentRoute.value.state?.singer;
